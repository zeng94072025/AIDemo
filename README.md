...
### 免费版功能
- **基础图片处理**：亮度、对比度调整，基础滤镜
- **每日3次限制**：免费用户每日可处理3张图片
- **实时使用统计**：显示今日使用次数和剩余额度
- **智能升级提醒**：使用量接近上限时提醒升级
...
### 普通用户
- **注册**：使用任意手机号进行短信验证码登录
- **默认免费版**：登录后自动使用免费版，无需选择套餐
- **套餐升级**：
  - 免费版：基础功能，每日3次处理限制
  - 专业版：¥2一次性付费，所有功能无限制
- **套餐管理**：通过顶部"套餐"按钮随时查看和升级套餐
...
- **LoginManager**：登录认证管理
- **SMSService**：短信验证码服务（支持真实运营商）
- **UsageManager**：使用次数管理（免费版限制）
